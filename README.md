...
<p align="center">
  ...
  <h3 align="center">Social Webscrapper</h3>

  <p align="center">
    Nowadays, social media is everywhere. To think of it, where's the best open source location you can check your company's reputation
  </p>
</p>
...
* Python
  ```sh
  Please use python version 2.7 (Reason cause some of the libraries are deprecated)
  ```
...
1. Clone the repo
   ```sh
   git clone https://github.com/jmateocarbon/google-twitter-webscrapper.git
   ```
